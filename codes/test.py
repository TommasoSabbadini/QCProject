...
basis = 'sto3g'
mapper = 'parity'
file = open(f'/home/tommi/venvs/files/results_{basis}_{mapper}_{f_time.hour}_{f_time.minute}_{f_time.second}.txt', 'w')
...
for d in dist_array:
    ...
    #     energy_dict[optimizers_str[idx]] = vqe_result.eigenvalues[0]
